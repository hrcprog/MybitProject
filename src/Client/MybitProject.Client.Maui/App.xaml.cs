...
public partial class App
{
    ...
    protected async override void OnStart()
    {
        ...
        webViewVersion.Major < minimumSupportedWebViewVersion)
            {
                await App.Current!.Windows.First().Page!.DisplayAlert("MybitProject", localizer[nameof(AppStrings.UpdateWebViewThroughGooglePlay)], localizer[nameof(AppStrings.Ok)]);
