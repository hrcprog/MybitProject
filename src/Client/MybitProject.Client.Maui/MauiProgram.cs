...
using MybitProject.Client.Core.Styles;
using MybitProject.Client.Maui.Services;
#if iOS || Mac
using UIKit;
using WebKit;
using Foundation;
...
public static partial class MauiProgram
{
    public static MauiApp CreateMauiApp()
    {
        ...
        var builder = MauiApp.CreateBuilder();
            ...
            .UseSentry(options =>
            {
                var configuration = new ConfigurationBuilder().AddClientConfigurations(clientEntryAssemblyName: "MybitProject.Client.Maui").Build();
                configuration.GetRequiredSection("Logging:Sentry").Bind(options);
            })
            .Configuration.AddClientConfigurations(clientEntryAssemblyName: "MybitProject.Client.Maui");
