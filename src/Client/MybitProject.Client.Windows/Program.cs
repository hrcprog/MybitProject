...
using MybitProject.Client.Core.Components;
using MybitProject.Client.Windows.Services;
using Microsoft.AspNetCore.Components.WebView.WindowsForms;

namespace MybitProject.Client.Windows;
...
public partial class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        var configuration = new ConfigurationBuilder().AddClientConfigurations(clientEntryAssemblyName: "MybitProject.Client.Windows").Build();
