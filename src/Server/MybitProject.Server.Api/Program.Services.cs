...
using MybitProject.Server.Api.Controllers;
using MybitProject.Server.Api.Models.Identity;
using MybitProject.Server.Api.Services.Identity;
...
public static partial class Program
{
    ...
    private static void AddSwaggerGen(WebApplicationBuilder builder)
    {
        ...
        {
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "MybitProject.Server.Api.xml"), includeControllerXmlComments: true);
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "MybitProject.Shared.xml"));
