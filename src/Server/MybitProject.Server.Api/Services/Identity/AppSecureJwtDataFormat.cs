...
namespace MybitProject.Server.Api.Services.Identity;

/// <summary>
/// Stores bearer token in jwt format
/// </summary>
public partial class AppSecureJwtDataFormat(ServerApiSettings appSettings, TokenValidationParameters validationParameters)
